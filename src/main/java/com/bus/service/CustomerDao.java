...
public class CustomerDao {
	...
	// this code logice to store database in user details:
	...
	// this code login and password code databse la irunthuchuna login agum illana invalid nu sollum  (athuku tha intha logic)
