...
public class BusController {
	...
	// Opening home page  and display home page movie image
	@GetMapping("/")
...
//	User save process  // register logic save proccess :
	@PostMapping("/save")
...
//	Login process  // login store process logic code:
	...
	// this method  Nama email and password kuduthu login pannathum oru home page varum la athuku intha method use pannurom: successfull mes varum
	@GetMapping("/home")
	public String mainDashboard(HttpSession session, Model m) {
		...
		//session.removeAttribute("movieName");g
		//m.addAttribute("menu", "home");
...
//	Seat booking process
	...
	private void sendBookingEmail(String recipientEmail, String movieName, LocalDate date, String time, List<String> seatNumbers) {
	    ...
	    String senderPassword = "uylqikhjcbydlczj"; // Replace with your email password
	...
	//	Order history  show order history in webpage:
...
//	Admin can see all Customers  and all user records:
